# Program Prediksi Peluang Diterima di Universitas Internasional dengan GUI, Sistem Pakar, dan Rekomendasi Universitas

import tkinter as tk
from tkinter import messagebox
from PIL import Image, ImageTk

# Daftar 10 Universitas Terbaik dengan Kriteria Penerimaan
UNIVERSITIES = [
    {
...
def evaluasi_peluang(user_data, university=None):
    skor = 0
    if university:
        # Jika universitas ditentukan, gunakan kriteria universitas tersebut
        ...
        # Asumsi: Sama seperti sebelumnya, dapat ditingkatkan atau diubah
        # Implementasi ini bisa disesuaikan jika diperlukan
        pass
...
root = tk.Tk()
root.title("Prediksi Penerimaan Universitas Internasional")
...
# Footer
label_footer = tk.Label(root, text="© 2024 Universitas Internasional", font=("Helvetica", 10), fg="grey")
